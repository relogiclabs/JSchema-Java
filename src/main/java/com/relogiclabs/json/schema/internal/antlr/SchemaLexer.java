...
public class SchemaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"TITLE", "VERSION", "INCLUDE", "PRAGMA", "DEFINE", "SCHEMA", "TRUE",
			"FALSE", "NULL", "COLON", "COMMA", "STAR", "LBRACE", "RBRACE", "LBRACKET",
			"RBRACKET", "LPAREN", "RPAREN", "OPTIONAL", "UNDEFINED", "IDENTIFIER",
			"ALIAS", "DATATYPE", "FUNCTION", "RECEIVER", "BASE_IDENTIFIER", "ALPHA",
			"ALPHANUMERIC", "STRING", "ESCAPE", "UNICODE", "HEXDIGIT", "SAFECODEPOINT",
			"INTEGER", "FLOAT", "DOUBLE", "INTDIGIT", "EXPONENT", "DIGIT", "MULTILINE_COMMENT",
			"LINE_COMMENT", "MULTILINE_CMT", "LINE_CMT", "WHITE_SPACE", "WHITE_SPC",
			"COLON1", "VERSION_NUMBER1", "WHITE_SPACE1", "MULTILINE_COMMENT1", "LINE_COMMENT1"
		};
	}
