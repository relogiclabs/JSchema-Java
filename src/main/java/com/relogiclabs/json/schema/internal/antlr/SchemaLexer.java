...
public class SchemaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ALIAS", "DATATYPE", "FUNCTION", "BASE_IDENTIFIER", "ALPHA", "ALPHANUMERIC",
			"STRING", "ESCAPE", "UNICODE", "HEXDIGIT", "SAFECODEPOINT", "INTEGER",
			"FLOAT", "DOUBLE", "INTDIGIT", "EXPONENT", "DIGIT", "MULTILINE_COMMENT",
